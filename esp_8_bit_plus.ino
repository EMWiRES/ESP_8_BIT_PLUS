...
//  Choose one of the following emulators: EMU_COLECOVISION
...
Emu* NewEmulator() {  
  #if (EMULATOR==EMU_COLECOVISION)
    return NewColecovision(VIDEO_STANDARD);
  #endif

  printf("Must choose one of the following emulators: EMU_COLECOVISION\n");
}
